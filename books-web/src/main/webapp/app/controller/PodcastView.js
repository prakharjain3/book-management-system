 ...
 */
App.controller('PodcastView', function($scope, $q, $timeout, $state, $stateParams, Restangular) {
  
  // Load book
  var bookPromise = Restangular.one('podcast', $stateParams.id).get().then(function(data) {
	  $scope.book = data;
  });
