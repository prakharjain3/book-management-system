...
public class UserContactDao {
    ...
    public List<UserContactDto> findByUserIdAndAppId(String userId, String appId) {
        EntityManager em = getEntityManager();
        String sb = "select uc.USC_ID_C, uc.USC_EXTERNALID_C " + " from T_USER_CONTACT uc" +
                " where uc.USC_IDUSER_C = :userId and uc.USC_IDAPP_C = :appId " +
                " and uc.USC_DELETEDATE_D is null ";
    ...
    public void updateByUserIdAndAppId(String userId, String appId) {
        EntityManager em = getEntityManager();
        String sb = "update T_USER_CONTACT uc" + " set uc.USC_UPDATEDATE_D = :updateDate " +
                " where uc.USC_IDUSER_C = :userId and uc.USC_IDAPP_C = :appId " +
                " and uc.USC_DELETEDATE_D is null ";
        Query q = em.createNativeQuery(sb);
    ...
    public void findByCriteria(PaginatedList<UserContactDto> paginatedList, UserContactCriteria criteria) {
        ...
        List<Object[]> l = PaginatedQuery.executePaginatedQuery(paginatedList, queryParam);
