...
public class DirectoryUtil {
    ...
    /**
     * Returns the podcast covers directory.
     * 
     * @return Podcast covers directory.
     */
    public static File getPodcastDirectory() {
        return getDataSubDirectory("podcast");
    }

    /**
     * Returns the audiobook covers directory.
     * 
     * @return Audiobook covers directory.
     */
    public static File getAudiobookDirectory() {
        return getDataSubDirectory("audiobook");
    }
