...
public class ValidationUtil {
    ...
    /**
     * Validates that the visibility is either public or private.
     * @param visibility Visibility to validate
     * @return validated visibility in lowercase
     * @throws JSONException
     */
    public static String validateVisibility(String visibility) throws JSONException {
        if (!"private".equals(visibility.toLowerCase()) && !"public".equals(visibility.toLowerCase())) {
            throw new ClientException("ValidationError", "Visibility must be 'private' or 'public'");
        }
